...
namespace PA3
{
    ...
    Student::Student(string student_name, string student_ID) : name(student_name), ID(student_ID), course_counter(0), course_rfr_size(0)
    { 
        course_references = nullptr; 
    }

    Student::Student() : course_counter(0), course_rfr_size(0)
    {
        course_references = nullptr; 
    }
    ...
    Course** Student::get_course_referencess() 
    { 
        return course_references; 
    }

    int Student::find_course_index(string name, string code)
    {
    ...
    ostream& operator<<(ostream& os, Student toBePrintedStudent)
    {
