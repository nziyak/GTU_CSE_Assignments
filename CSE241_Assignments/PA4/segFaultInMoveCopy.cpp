...
void Arena::SimulateOneStep()
{
    ...
    /*for(int k=0; k < Robot::totalRobotsNum; k++)
    {
...
{
    Robot* toMoveRobot = grid[x][y];
    int nearby = isNearby(toMoveRobot->x, toMoveRobot->y); //look for is any robot nearby
    ...
    {    
        ...
        {
            if ((toMoveRobot->y > 0) && (getAt(toMoveRobot->x, toMoveRobot->y-1)==nullptr))
            {
                setAt(toMoveRobot->x, toMoveRobot->y-1, toMoveRobot);
                if(getAt(toMoveRobot->x, toMoveRobot->y-1) == nullptr) cout << "NUL BUUU\n";
                toMoveRobot->moved = true; //mark it as moved
                setAt(toMoveRobot->x, toMoveRobot->y, nullptr);
                toMoveRobot->y--;
            }
        }
        ...
        {
            if ((toMoveRobot->y < ARENASIZE-1) && (getAt(toMoveRobot->x, toMoveRobot->y+1)==nullptr))
            {
                setAt(toMoveRobot->x, toMoveRobot->y+1, toMoveRobot);
                if(getAt(toMoveRobot->x, toMoveRobot->y+1) == nullptr) cout << "NULL BUUU\n";
                toMoveRobot->moved = true; //mark it as moved
                setAt(toMoveRobot->x, toMoveRobot->y, nullptr); 
                toMoveRobot->y++;
            }
        ...
        {
            if ((toMoveRobot->x > 0) && (getAt(toMoveRobot->x-1, toMoveRobot->y)==nullptr))
            {
                setAt(toMoveRobot->x-1, toMoveRobot->y, toMoveRobot);
                if(getAt(toMoveRobot->x-1, toMoveRobot->y) == nullptr) cout << "NULLL BUUU\n";
                toMoveRobot->moved = true; //mark it as moved
                setAt(toMoveRobot->x, toMoveRobot->y, nullptr); 
                toMoveRobot->x--;
            }
        ...
        {
            if ((toMoveRobot->x < ARENASIZE-1) && (getAt(toMoveRobot->x+1, toMoveRobot->y)==nullptr))
            {
                setAt(toMoveRobot->x+1, toMoveRobot->y, toMoveRobot);
                if(getAt(toMoveRobot->x+1, toMoveRobot->y) == nullptr) cout << "NULLLL BUUU\n";
                toMoveRobot->moved = true; //mark it as moved 
                setAt(toMoveRobot->x, toMoveRobot->y, nullptr); 
                toMoveRobot->x++;
            }
        ...
        nearby = isNearby(toMoveRobot->x, toMoveRobot->y);
    }

    if (nearby == 1) //if opponent is at the LEFT cell
    {
        deadCase = duel(toMoveRobot, getAt(toMoveRobot->x, toMoveRobot->y-1));
        if(deadCase == 1)
        {
            delete (grid[toMoveRobot->x][toMoveRobot->y]);
            grid[toMoveRobot->x][toMoveRobot->y] = nullptr;
        } 
        
        if(deadCase == 2)
        {
            delete (grid[toMoveRobot->x][toMoveRobot->y-1]);
            grid[toMoveRobot->x][toMoveRobot->y-1] = nullptr;
        }
    }
    ...
    {
        deadCase = duel(toMoveRobot, getAt(toMoveRobot->x-1, toMoveRobot->y));
        if(deadCase == 1)
        {
            delete (grid[toMoveRobot->x][toMoveRobot->y]);
            grid[toMoveRobot->x][toMoveRobot->y] = nullptr;
        ...
        if(deadCase == 2)
        {
            delete (grid[toMoveRobot->x-1][toMoveRobot->y]);
            grid[toMoveRobot->x-1][toMoveRobot->y] = nullptr;
        }
    }
...
//TODO: SOLVE ROBOTS ATTACKING THEMSELVES. AND AT EVERY STEP JUST THE FIRST ROBOT FROM BEGINNING OF MAP MUST FIGHT.
...
int main()
{
    ...
    string s;
    while (Robot::totalRobotsNum > 0)
    {
        DeadEarth.Display();
        DeadEarth.SimulateOneStep();
        cout << "totalRobotsNum:" << Robot::totalRobotsNum << endl;
